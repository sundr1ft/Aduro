...
describe('output files', () => {
  ...
  test('generates hello-world post', () =>
    expect(exists('posts/hello-world/index.html')).toBe(true));
  test('generates second-post', () => expect(exists('posts/second-post/index.html')).toBe(true));
  test('generates post with no date', () =>
    expect(exists('posts/no-date-post/index.html')).toBe(true));
